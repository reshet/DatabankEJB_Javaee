...
public class MetaUnitMultivaluedEntityDTO extends MetaUnitMultivaluedDTO implements Serializable{
	...
	{
		MetaUnitMultivaluedEntityDTO dto = new MetaUnitMultivaluedEntityDTO(this.getId(), this.getDesc(), this.getUnique_name());
		...
		dto.setItem_ids(this.getItem_ids());
		dto.setItem_names(this.getItem_names());
		return dto;
	}
